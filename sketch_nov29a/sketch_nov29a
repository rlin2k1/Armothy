...
void loop()
{
  ...
  extract_and_transmit_imu(imu_d1, "1");
  //////////////////////////////////////////////////////////
  //////IMU2 DATA INPUT
  //////////////////////////////////////////////////////////
  tcaselect(6);
  ...
  extract_and_transmit_imu(imu_d2, "2");
  ...
  extract_and_transmit_imu(imu_d3, "3");
}

void extract_and_transmit_imu(imu_data* imu_d, String imu_num){
    yaw   = atan2(2.0f * (imu_d->q[1] * imu_d->q[2] + imu_d->q[0] * imu_d->q[3]), imu_d->q[0] * imu_d->q[0] + imu_d->q[1] * imu_d->q[1] - imu_d->q[2] * imu_d->q[2] - imu_d->q[3] * imu_d->q[3]);   
    pitch = -asin(2.0f * (imu_d->q[1] * imu_d->q[3] - imu_d->q[0] * imu_d->q[2]));
    roll  = atan2(2.0f * (imu_d->q[0] * imu_d->q[1] + imu_d->q[2] * imu_d->q[3]), imu_d->q[0] * imu_d->q[0] - imu_d->q[1] * imu_d->q[1] - imu_d->q[2] * imu_d->q[2] + imu_d->q[3] * imu_d->q[3]);
    pitch *= 180.0f / PI;
    yaw   *= 180.0f / PI; 
    ...
    packet += imu_num; packet += ",";
    if(imu_num == "1") {
        packet += String(angle);
        packet += ",";
    }
    packet += String(imu_d->yaw); packet += ",";
    packet += String(imu_d->pitch); packet += ",";
    packet += String(imu_d->roll);   
